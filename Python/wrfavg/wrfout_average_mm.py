...
A script to average WRF output; the default settings are meant for Andre's 'fineIO' output configuration  
and process the smaller diagnostic files. The script can run in parallel mode, with each process averaging 
one filetype and domain, producing exactly one output file.  
...
# NOTE: The above imports the module providing derived variable classes.
